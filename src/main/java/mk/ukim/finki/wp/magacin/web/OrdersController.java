...
//    }
//
//    shoppingCartService.deleteAllItems(cart.getId());
//    orderService.placeOrder(
//        firstName, lastName, email, address, country, city, zipCode, totalPrice, itemsList, request.getRemoteUser());
//
//    for (ShoppingCartItem item : items) {
//      if (item.getItem().getTotalQuantity() <= 5)
//        reportService.generateReport(item.getItem().getName());
//    }
//    return "redirect:/";
//  }
//
...
//
//  @PreAuthorize("hasRole('ROLE_USER')")
//  @PostMapping("/my-orders/{id}")
//  public String userOrderDetailsChange(
